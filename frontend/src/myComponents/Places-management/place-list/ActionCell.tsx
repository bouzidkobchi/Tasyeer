...
const Edit=()=>{
    ...
    <DialogContent className="min-w-fit">
      <DialogHeader>
        <DialogTitle className={`text-[${colors.main}] mb-14 text-3xl`}>Modify Place</DialogTitle>
        <div style={{marginBottom:'60px'}} className="flex gap-10 justify-between items-star mb-10">
            <div className="">
                {picture 
                ? <img src={ ''} alt="" className="min-w-[300px] min-h-[280px] object-contain border rounded-3xl" />

...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Scientifique'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiAubergeAuberge extends Struct.CollectionTypeSchema {
...
export interface ApiToristicComplexToristicComplex
  ...
  info: {
    displayName: 'ToristicComplex';
    pluralName: 'toristic-complexes';
    singularName: 'toristic-complex';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::toristic-complex.toristic-complex'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiToristicPlaceToristicPlace
  extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    IdentityCardNumber: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'

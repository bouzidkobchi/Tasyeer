        ...
        <Button className={`text-green font-medium dbg-[${colors.main}] text-white py-0  flex  rounded-lg  px-3 `}>
          <Dialog>
            ...
            <DialogContent className="min-w-fit">
              <DialogHeader>
                <DialogTitle className={`text-[${colors.main}] mb-14 text-3xl`}>Add a new place</DialogTitle>
                <div style={{marginBottom:'60px'}} className="flex gap-10 justify-between items-star mb-10">
                    ...
                    <div className="">
                        ...
                        <div className="flex flex-col gap-2 justify-between mb-4 ">
                            <label htmlFor="name" className="min-w-fit font-medium">Category</label>
                            <Input  id="name" type="text" className="h-fit w-[300px]"/>
                        </div>
                        <div className="flex flex-col gap-2 justify-between mb-4">
                            <label htmlFor="location" className="min-w-fit font-medium">Location</label>
                            <Input id="location" className="h-fit  w-[300px]"/>
                        </div>
                        {/* <div className="">
